...
CREATE TABLE `salary` (
  ...
  CONSTRAINT `salary_ibfk_1` FOREIGN KEY (`employeeNumber`) REFERENCES `employee` (`employeeNumber`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sessions` VALUES ('Xy_UhowG80tstFGrPDhY4E_yQSyN892C',1747715244,'{\"cookie\":{\"originalMaxAge\":3600000,\"expires\":\"2025-05-20T04:19:19.081Z\",\"httpOnly\":true,\"path\":\"/\"},\"user\":{\"id\":1,\"username\":\"admin\",\"role\":\"admin\"}}');
...
-- Dump completed on 2025-05-20  5:30:57
